/**
 * @type {object} variable contenant le module retourné par require('./User').
 */
var User = require('./User');
/**
 * @type {object} variable contenant le module retourné par require('./bdd').
 */
var bdd=require('./bdd');
/**
 * @type {object} variable contenant le module retourné par require('./Formulaire').
 */
